 ...
 * AnonymousAuthenticationFilter; import
 ...
 * 
 * @Override public void configure(final WebSecurity webSecurity) {
 ...
 * .logout().disable(); }
 * 
 * @Bean AuthenticationFilter authenticationFilter() throws Exception { final
 ...
 * 
 * @Bean AuthenticationEntryPoint forbiddenEntryPoint() { return new
